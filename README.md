...
<table>
  ...
  <tr>
   <td><strong>브랜드 정의</strong>
   </td>
   <td>창작자의 뇌파와 디자인 무드를 실시간으로 감지하여 고유한 디지털 텍스처와 가구 오브제로 구현하는 미래형 크리에이티브 퍼니처/미술 브랜드
   </td>
  </tr>
  <tr>
   <td><strong>타겟</strong>
   </td>
   <td>예술적 감성을 중시하는 2030 영크리에이터, 디자이너, 아티스트 및 감각적인 인테리어 매니아
   </td>
  </tr>
  <tr>
   <td><strong>톤앤매너</strong>
   </td>
   <td>초현실주의(Surrealism), 미니멀리즘, 영롱하고 몽환적인 3D 그래픽, 액체 금속 유기적 형태, 신비로움
   </td>
  </tr>
  <tr>
   <td><strong>차별점(USP)</strong>
   </td>
   <td>"디자이너의 영감이 물리적 공간으로 흘러넘치다" — 감정과 아이디어를 시각적 가구 오브제로 연결
   </td>
  </tr>
  <tr>
   <td><strong>캠페인 목표</strong>
   </td>
   <td>신규 브랜드 'Aura'의 가치 제고 및 브랜드 이미지 각인 (인지 캠페인)
   </td>
  </tr>
  <tr>
